...
INSERT INTO Users (email, fieldID) VALUES ('statuser@test.com', (SELECT fieldID FROM Fields WHERE fieldName = 'Statistics') );


-- Article Data: College Major Salaries

INSERT INTO Articles (title, authorEmail) VALUES ('College Major Salaries','statuser@test.com');
...
INSERT INTO Articles (title, authorEmail) VALUES ('G-20 GINI Coefficients','statuser@test.com');
...
INSERT INTO Articles (title, authorEmail) VALUES ('World Population','statuser@test.com');
...
INSERT INTO Articles (title, authorEmail) VALUES ('Property Crime','statuser@test.com');
...
CREATE TABLE stats_USPropertyCrime ( id INT NOT NULL AUTO_INCREMENT, Year SMALLINT NOT NULL, Population INT NOT NULL, Total_Property_Crime INT NOT NULL, Burglary INT NOT NULL, Larceny INT NOT NULL, Auto INT NOT NULL, PRIMARY KEY (id) );

LOAD DATA INFILE '/tmp/US Crime Estimates.csv' INTO TABLE stats_USPropertyCrime FIELDS TERMINATED BY ',' ENCLOSED BY '"' LINES TERMINATED BY '\n' IGNORE 1 ROWS (Year, Population, Total_Property_Crime, Burglary, Larceny, Auto) SET ID=DEFAULT;
